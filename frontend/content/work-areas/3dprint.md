...
## Printers Available
- **5 × [Prusa i3 MK3S](https://help.prusa3d.com/product/mk3s)** – reliable, high-quality FDM printers with advanced features such as automatic bed leveling and filament runout detection.
- **1 × Creality Ender 3** – a versatile and beginner-friendly printer ideal for simple projects and experimentation.

## Supported Materials
If you are new to 3D printing, we recommend to use PLA. We have a lot of colors you can start to play with. For any other material, we assume that you know what you are doing and can take care of simple maintenance of the 3D printer.
- PLA (various colors)
- PETG
