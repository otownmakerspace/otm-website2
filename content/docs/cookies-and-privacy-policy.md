...
3. Stored data for members and volunteers includes:
    - Name
    - Contact information
...
- **Right to deletion:** You can have your personal information deleted.
- **Right to object:** You can object to the treatment or limit the use of your personal information.
- **Right to port data:** You can export your data in a commonly used format.
...
3. Internet data transfer carries risks; users disclose personal information at their own discretion.
